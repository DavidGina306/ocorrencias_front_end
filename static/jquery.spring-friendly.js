...
(function ($) {
  const r20 = /%20/g; const rbracket = /\[\]$/; const rCRLF = /\r?\n/g; const rsubmitterTypes = /^(?:submit|button|image|reset|file)$/i; const rsubmittable = /^(?:input|select|textarea|keygen)/i
  ...
  $.param = function (a, traditional) {
    let prefix; const s = []; const add = function (key, value) {
